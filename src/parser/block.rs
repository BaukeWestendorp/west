...
#[cfg(test)]
mod tests {
    // use crate::ast::{Block, Expression, ExpressionKind, Literal, LiteralKind, StatementKind};

    // use crate::parser::error::ParserError;
    // use crate::{check_parser, check_parser_error, span};
    ...
    //         source: r#"{"#,
    //         fn: parse_block,
    //         expected: Error { kind: , span: span!(1, 1) }
    //     }
    // }
